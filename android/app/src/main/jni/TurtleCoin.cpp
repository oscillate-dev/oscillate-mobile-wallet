...
extern "C" jint JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    KEY_OUTPUT = (jclass) env->NewGlobalRef(env->FindClass("com/oscillate/wallet/KeyOutput"));
    ...
    RAW_TRANSACTION = (jclass) env->NewGlobalRef(env->FindClass("com/oscillate/wallet/RawTransaction"));
    RAW_TRANSACTION_CONST = env->GetMethodID(RAW_TRANSACTION, "<init>", "([Lcom/oscillate/wallet/KeyOutput;Ljava/lang/String;Ljava/lang/String;)V");
    RAW_TRANSACTION_KEY_OUTPUTS = env->GetFieldID(RAW_TRANSACTION, "keyOutputs", "[Lcom/oscillate/wallet/KeyOutput;");
    ...
    WALLET_BLOCK_INFO = (jclass) env->NewGlobalRef(env->FindClass("com/oscillate/wallet/WalletBlockInfo"));
    WALLET_BLOCK_INFO_CONST = env->GetMethodID(WALLET_BLOCK_INFO, "<init>", "(Lcom/oscillate/wallet/RawTransaction;[Lcom/oscillate/wallet/RawTransaction;)V");
    WALLET_BLOCK_INFO_COINBASE_TRANSACTION = env->GetFieldID(WALLET_BLOCK_INFO, "coinbaseTransaction", "Lcom/oscillate/wallet/RawTransaction;");
    WALLET_BLOCK_INFO_TRANSACTIONS = env->GetFieldID(WALLET_BLOCK_INFO, "transactions", "[Lcom/oscillate/wallet/RawTransaction;");

    TRANSACTION_INPUT = (jclass) env->NewGlobalRef(env->FindClass("com/oscillate/wallet/TransactionInput"));
    ...
    SPEND_KEY = (jclass) env->NewGlobalRef(env->FindClass("com/oscillate/wallet/SpendKey"));
    ...
    INPUT_MAP = (jclass) env->NewGlobalRef(env->FindClass("com/oscillate/wallet/InputMap"));
    INPUT_MAP_CONST = env->GetMethodID(INPUT_MAP, "<init>", "(Ljava/lang/String;Lcom/oscillate/wallet/TransactionInput;)V");
    INPUT_MAP_PUBLIC_SPEND_KEY = env->GetFieldID(INPUT_MAP, "publicSpendKey", "Ljava/lang/String;");
    INPUT_MAP_TRANSACTION_INPUT = env->GetFieldID(INPUT_MAP, "input", "Lcom/oscillate/wallet/TransactionInput;");
...
Java_com_oscillate_wallet_TurtleCoinModule_processBlockOutputsJNI(
    JNIEnv *env,
    jobject instance,
...
extern "C" JNIEXPORT jobjectArray JNICALL
Java_com_oscillate_wallet_TurtleCoinModule_generateRingSignaturesJNI(
    JNIEnv *env,
    jobject instance,
    jstring jPrefixHash,
    jstring jKeyImage,
...
Java_com_oscillate_wallet_TurtleCoinModule_generateKeyDerivationJNI(
    JNIEnv *env,
    jobject instance,
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_oscillate_wallet_TurtleCoinModule_generateKeyImageJNI(
    JNIEnv *env,
    jobject instance,
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_oscillate_wallet_TurtleCoinModule_deriveSecretKeyJNI(
    JNIEnv *env,
    jobject instance,
    jstring jDerivation,
    jlong outputIndex,
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_oscillate_wallet_TurtleCoinModule_derivePublicKeyJNI(
    JNIEnv *env,
    jobject instance,
    jstring jDerivation,
    jlong outputIndex,
